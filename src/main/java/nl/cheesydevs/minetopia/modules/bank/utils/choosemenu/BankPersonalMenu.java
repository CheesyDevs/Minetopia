...
public class BankPersonalMenu extends MinetopiaGui {
    ...
    public Inventory getInventory(Player player) {
        return BankChooseMenu.getInventory(player, new ChestGui(this), RekeningType.PERSONAL);
    }
    ...
    public void onInventoryClickEvent(InventoryClickEvent e) {
        ...
        for (Rekening rekening : Minetopia.getApi().getBanking().getPlayerRekening((Player)e.getWhoClicked(), RekeningType.PERSONAL)) {
